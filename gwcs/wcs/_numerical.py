...
__all__ = ["NumericalMixin"]


class NumericalMixin(BaseGwcs):
    """
    This mixin provides the numerical approximation interface for the WCS.

    It is a separate class to allow for a clear division of the interface.
    """

    def __init__(self) -> None:
        self._approx_inverse: Mdl | None = None
