...
from gwcs._typing import LowLevelArrays, LowOrHigh, Mdl, Real
...
__all__ = ["InverseMixin"]


class InverseMixin(BaseGwcs):
    """
    Mixin class to handle approximating inverse transformations.
    """

    def __init__(self):
        self._approx_inverse: Mdl = None
