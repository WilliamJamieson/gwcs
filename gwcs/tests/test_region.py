...
def test_LabelMapperArray_from_vertices_int():
    regions = {
        1: [[795, 970], [2047, 970], [2047, 999], [795, 999], [795, 970]],
...
def test_LabelMapperArray_from_vertices_string():
    regions = {
        "S1600A1": [[795, 970], [2047, 970], [2047, 999], [795, 999], [795, 970]],
...
def test_LabelMapperDict():
    ...
    with pytest.raises(TypeError):
        selector.LabelMapperDict(
            ("x", "y"), mapper={1: models.Rotation2D(23), 2: models.Shift(1)}
        )
...
def test_LabelMapperRange():
    ...
    with pytest.raises(TypeError):
        selector.LabelMapperRange(
            ("x", "y"), mapper={(1, 5): models.Rotation2D(23), (7, 10): models.Shift(1)}
        )
...
def test_RegionsSelector():
    ...
    with pytest.raises(ValueError):  # noqa: PT011
        ...
        selector.RegionsSelector(
            ...
            label_mapper=mapper,
            selector={
                0: models.Shift(1) & models.Scale(1),
                2: models.Shift(2) & models.Scale(2),
            },
        )

    reg_selector = selector.RegionsSelector(
